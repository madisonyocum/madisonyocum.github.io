...
export const projects: Project[] = [
...

  {
    ...
    detail: {
      ...
      what: "I designed and coded it. I set the product direction and strategy, and defined the component system the whole build ran on, so a decision made once held across every screen rather than being re-made each time. Designing and building it myself kept those decisions honest - anything I specified, I then had to build, so the gap between what was designed and what shipped never opened up.",
      impact:
